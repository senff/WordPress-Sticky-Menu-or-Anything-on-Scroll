...
(function ($) {
  ...
  $.fn.stickThis = function(options) {
    ...
    if (numElements < 1) {
      ...
      if(settings.legacymode == true) {
        ...
        $(this).addClass('sticky-element-original').attr('style','margin:47px; border:solid 3px #00ff00; padding:40px;');
        orgInlineStyles = $('.sticky-element-original').attr('style');

        createPlaceholder();
        checkElement = setInterval(function(){stickIt(settings.top,settings.minscreenwidth,settings.maxscreenwidth,settings.zindex,settings.pushup,settings.adminbar,orgInlineStyles)},10);
      }
    }
  ...
  function stickIt(stickyTop,minwidth,maxwidth,stickyZindex,pushup,adminbar,originalStyles) {
